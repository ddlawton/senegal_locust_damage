...
ose_number_treatment_village_mission <- dat |>
  ggplot(aes(x=mission,y=ose_num_adj,color=village,group=farmer_num)) +
    geom_line(alpha=0.5) +
    geom_point(size=2) +
    scale_color_met_d(name='Demuth') +
    ylab("locust count") +
...
## locust abundance and millet attacl
...
dat |>
  ggplot(aes(x=mission,y=att_mil_adj,color=village,group=farmer_num)) +
    geom_line(alpha=0.5) +
    geom_point(size=2) +
    scale_color_met_d(name='Demuth') +
    theme_pubr() +
...
locust_dat <- dat |>
  select(farmer_num,village,treatment,ose_num_adj,att_mil_adj,mission) |>
